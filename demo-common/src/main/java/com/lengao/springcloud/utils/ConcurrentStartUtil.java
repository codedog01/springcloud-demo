...
public class ConcurrentStartUtil<T> {
   ...
   static SimpleDateFormat format = new SimpleDateFormat(DATE_FORMAT_EXPR);

    public static void main(String[] args) {
        start(101010, () -> format.format(new Date(System.currentTimeMillis())),Exception::printStackTrace).forEach((key, value) -> System.out.println(value));
    }
